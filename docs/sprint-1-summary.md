...
- HeadCoach/AssistantCoach designations on UserRole.designation remain unchanged (they describe the coaching _function_ within a Staff role)
...
### Implemented But Needs Better Coverage

- Offer system (team offers to players, parent responses, roster creation)
- Offer notifications and email send path
- Team roster finalization and jersey assignment workflow
