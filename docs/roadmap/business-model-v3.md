...
13. 🔴 **Card markup** (§3e) — **UPGRADED to a close-it decision, 2026-08-19.** [[communiti-2026-08]] is the third competitor undercutting us here, and the first to advertise it: their pricing page says in public *"We do not add any markup to these fees."* RAMP is under 2% all-in, TeamLinkt 2.7% + 30¢, Communiti passthrough, us 3.4–4.9%. Three rivals can say a sentence we cannot. Recommend closing as **passthrough + 0**, taking margin on e-transfer only.
13b. 🔴 **The shape of Club Pro, not just its price** — Communiti charges **$0/month and adds 2% on top, paid by the PARENT**, so the club never receives an invoice at all. Modelled on a 12-team club at $86,400 volume: their club pays $2,599 (all Stripe), ours pays $3,139 at passthrough, and ours is the only one that arrives as a bill. The arithmetic gap is modest; the psychological gap is not. Does Pro become transaction-borne, or waived above a volume line?
14b. ⚠️ **Card markup** (§3e, original wording) — RAMP is under 2% all-in and TeamLinkt 2.7% + $0.30, while we land at 3.4–4.9%. Drop the card markup to **passthrough + 0** and take margin only on e-transfer? That buys "we never mark up your card fees," which nobody else in Canada can say.
