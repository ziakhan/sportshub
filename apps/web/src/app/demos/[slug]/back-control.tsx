...
export function DemoBackControl() {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-[44px] shrink-0 items-center gap-1.5 rounded-xl py-2 pl-2 pr-3 text-[14px] font-bold text-ink-600 outline-none transition-colors duration-200 hover:bg-ink-100 hover:text-ink-950 focus-visible:ring-2 focus-visible:ring-gold-500/70"
    >
      <svg
        viewBox="0 0 24 24"
        fill="none"
