...
export function ScheduleTab({
  ...
  // WHOLE-SEASON ONLY (owner rulings 2026-08-08): session-by-session
  // GENERATION is dead — the engine always solves the entire season and
  // publishing will stage by session instead (H8). The constant keeps the
  // legacy branches compiled-but-dead until the kill-list pass removes
  // them wholesale.
  const mode = "season" as "session" | "season"
