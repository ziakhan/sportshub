  ...
  return (
    <aside className="border-ink-100 hidden w-[268px] flex-shrink-0 border-r bg-[#fcfcfc] lg:flex lg:flex-col">
      ...
      <div className="border-ink-100 border-t px-3 py-3">
        <div className="hover:bg-ink-50 flex items-center gap-3 rounded-xl px-3 py-2 transition">
          <div className="from-play-400 to-play-600 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br text-[11px] font-bold text-white shadow-sm">
            {userInitials}
          </div>
          <div className="min-w-0">
            <div className="text-ink-950 truncate text-sm font-medium">{userName}</div>
            <div className="text-ink-400 truncate text-[11px]">{primaryRole}</div>
          </div>
        </div>
      </div>
    </aside>
  ...
  return (
    <Link
      ...
      className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition ${
        active
          ? "bg-play-50 text-play-700 shadow-soft"
