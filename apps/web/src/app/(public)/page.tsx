      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="mb-10 text-center">
            ...
            <p className="text-ink-500 mx-auto max-w-xl text-base leading-7 sm:text-lg">
              Whether you&apos;re a parent, a club, or a league, there&apos;s a clear path built for
              you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
            ...
            >
              <span className="bg-hoop-500 shadow-hoop-200 mb-5 flex h-12 w-12 items-center justify-center rounded-2xl shadow-lg">
              ...
              <span className="text-hoop-500 mb-1 text-xs font-semibold uppercase tracking-[0.18em]">
                Families
              </span>
              <h3 className="text-ink-950 mb-2 text-xl font-bold">Find programs & follow teams</h3>
              <p className="text-ink-500 mb-6 flex-1 text-sm leading-6">
                Browse tryouts, camps, and leagues near you, sign up your kids, and keep up with
                their schedule, games, and stats.
              </p>
              <span className="text-hoop-600 group-hover:text-hoop-700 inline-flex items-center gap-1 text-sm font-semibold transition">
                Browse programs
            ...
            >
              ...
              <span className="text-play-500 mb-1 text-xs font-semibold uppercase tracking-[0.18em]">
                Clubs
              </span>
            ...
            >
              ...
              <span className="text-court-600 mb-1 text-xs font-semibold uppercase tracking-[0.18em]">
                Leagues
              </span>
              <h3 className="text-ink-950 mb-2 text-xl font-bold">Organize competitive play</h3>
              <p className="text-ink-500 mb-6 flex-1 text-sm leading-6">
                Build divisions, generate schedules, and publish live standings that players and
                parents can follow all season.
              </p>
              <span className="text-court-700 group-hover:text-court-800 inline-flex items-center gap-1 text-sm font-semibold transition">
                Start a league
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                  <path d="M5 12h14M12 5l7 7-7 7" />
                </svg>
