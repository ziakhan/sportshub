...
export default function UnsubscribedPage({
  ...
  return (
    ...
    >
      <div className="border-ink-100 shadow-panel rounded-[30px] border bg-white p-8 text-center sm:p-10">
        {status === "ok" ? (
          <>
            <div className="bg-court-50 text-court-600 mx-auto mb-4 grid h-14 w-14 place-items-center rounded-2xl">
          ...
          <>
            <div className="bg-hoop-50 text-hoop-600 mx-auto mb-4 grid h-14 w-14 place-items-center rounded-2xl">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-7 w-7">
        ...
        <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            ...
            className="bg-play-600 hover:bg-play-700 rounded-xl px-4 py-2.5 text-center text-sm font-semibold text-white transition"
          >
            Manage email preferences
          </Link>
          <Link
            href="/"
            className="border-ink-200 text-ink-700 hover:bg-ink-50 rounded-xl border bg-white px-4 py-2.5 text-center text-sm font-semibold transition"
          >
            Home
          </Link>
        </div>
