...
export async function POST(request: Request) {
  try {
    ...
    // this email to become their guardian. Shared with the Google/Apple path
    // so an invited parent finds the invite whichever way they sign up.
    await attachPendingFamilyInvitations(user.id, normalizedEmail)
