...
const LIB: LibScene[] = [
  ...
  },
  {
    ...
    personaLabel: PARENT_LABEL,
    frame: "phone",
    caption: "The news page fills itself: a story for every scored game, next to club and league announcements. Maria opens the recap of Jayden's win.",
    screen: SceneNewsBrowse,
  },
  {
    id: "recap",
    chapter: "season",
