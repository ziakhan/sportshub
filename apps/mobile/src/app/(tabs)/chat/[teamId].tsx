...
const styles = StyleSheet.create({
  ...
  sender: { fontSize: 13, fontWeight: "700", color: palette.play[700], marginBottom: 2 },
  body: { fontSize: 16, color: ui.text },
  bodyMine: { color: "#fff" },
  pinTag: { fontSize: 11, color: palette.gold[600], marginBottom: 2, fontWeight: "700" },
  editedTag: { fontSize: 11, color: ui.textFaint, marginTop: 2, fontStyle: "italic" },
  ...
  reactionText: { fontSize: 12, color: ui.text },
  ...
  quickPillText: { fontSize: 13, fontWeight: "600", color: ui.text },
  pinnedBanner: {
  ...
  pinnedLine: { fontSize: 13, color: ui.text },
  typing: { fontSize: 12, color: ui.textFaint, fontStyle: "italic", paddingHorizontal: 14, paddingBottom: 2 },
  editBanner: {
    flexDirection: "row",
